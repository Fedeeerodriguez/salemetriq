...
export default function Perfiles() {
  ...
  async function cargar() {
    ...
    try {
      ...
      const { data } = await api.get("/igp/perfiles", { params });
  ...
  useEffect(() => {
    ...
    api.get("/igp/listas").then(({ data }) => setListas(data)).catch(() => {});
    cargar();
  }, []); // eslint-disable-line
  ...
  async function agregarALista() {
    ...
    await api.post(`/igp/listas/${listaSel}/perfiles`, { usernames: [...sel] });
