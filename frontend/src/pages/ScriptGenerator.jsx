        ...
        <div className="card p-5 flex flex-col gap-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {PLANTILLAS.map((p) => (
                <button key={p} className="text-[12.5px] px-3 py-1.5 rounded-full border border-ink-line text-txt-soft hover:text-iris-400 hover:border-iris-500/40 transition-colors">
                  {p}
                </button>
              ))}
            </div>
          ...
          <button className="btn-primary flex items-center justify-center gap-2 text-[14px]">
